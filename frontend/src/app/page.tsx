            ...
            <InfoTooltip label={formatDatasetLabel(filterOptions.dataset_name)}>
              {isCanadaSnapshot ? (
                <>
                  ...
                  <br />
                  {formatCount(summary.job_count)} openings collected directly
                  from the career pages of {formatCount(summary.company_count)}{" "}
                  Canadian employers, across{" "}
                  {formatCount(summary.location_count)} locations.
                  ...
                  <br />
                  <br />
                  These are real postings, not made-up examples. JobLens reads
                  each description to work out which skills it asks for.
                </>
              ) : (
                <>
                  ...
                  {formatCount(summary.location_count)} locations. Switch
                  datasets from the menu at the top of the page.
                </>
              )}
            </InfoTooltip>
